...
def read(dataset = "training", path = "."):
    if dataset is "training":
        fname_img = os.path.join(path, 'emnist-digits-train-images-idx3-ubyte')
        fname_lbl = os.path.join(path, 'emnist-digits-train-labels-idx1-ubyte')
    elif dataset is "testing":
        fname_img = os.path.join(path, 'emnist-digits-test-images-idx3-ubyte')
        fname_lbl = os.path.join(path, 'emnist-digits-test-labels-idx1-ubyte')
    else:
