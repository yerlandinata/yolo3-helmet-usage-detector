...
RUN wget -O drive https://drive.google.com/uc?id=0B3X9GlR6EmbnMHBMVWtKaEZXdDg && mv drive /usr/bin/drive && chmod 755 /usr/bin/drive 

RUN ${PIP} install requests matplotlib keras Pillow

RUN mkdir /project && chmod a+rwx /project
COPY . /project
